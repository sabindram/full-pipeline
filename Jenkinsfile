pipeline {
    ...
    environment {
        ...
        IMAGE_NAME     = "fintech-python-app-sabindramaharjan" // Add your name here
        CONTAINER_NAME = "fintech-prod-container-sabindramaharjan" // Add your name here
        
        // ZAP Configuration
        ZAP_PORT       = "9008" // Change the port
        
        // Map Cosign Credentials
        COSIGN_PASSWORD = credentials('cosign-private-key')
        SONAR_SERVER_NAME = "sonar-server-admin"
        SONAR_PROJECT_KEY = "fintech-app-trainer-sabindramaharjan" // Add your name here
    }
